...
import { buildSteps, PHASES } from './rideMatching'
import { ensureAudio, setMuted, playCompare, playDone, playEnqueue, playInsert } from '../../../audio/sounds'

const BASE_DELAY_MS = 1700

const BADGES = [
  { label: 'DISPATCH', value: 'driver matching', color: '#0d9488' },
  { label: 'FACTORS', value: 'distance + 4 more', color: '#3b82f6' },
]

export default function RideMatchingMaterial() {
  ...
  return (
    <>
      <MaterialStage>
        <div className="flex h-full w-full flex-col items-center" style={{ paddingTop: 60, paddingBottom: 72, gap: 18 }}>
          <TitleBlock title="RIDE MATCHING" subtitle={PHASES[step.phase].desc} badges={BADGES} />

          <StrategyBar phase={step.phase} />

          <MapView step={step} />

          <ScoreBoard step={step} />
